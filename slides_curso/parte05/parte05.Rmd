...
Seja $X_{1},...,X_{n}$ uma amostra aleatória de tamanho $n$ tal que $X\sim Exp(2)$: 
$$f_{X_{i}}(x)=2e^{-2x}, \qquad \mbox{para } x \geq 0$$

Então $E\left(X_{i}\right)=\frac{1}{2}$ e $Var\left(X_{i}\right)=\frac{1}{4}$.

Suponha que $X_{i}$ modela o tempo de vida de um transistor em horas.  Os tempos de vida de 100 transistores são coletados.  Desejamos estudar a variável aleatória $\bar{X}_{100}$ (média amostral de uma amostra de tamanho 100). Sabemos:
$$E\left(\bar{X}_{100}\right)=\frac{1}{2} \qquad \mbox{e} \qquad Var\left(\bar{X}_{100}\right)=\frac{1/4}{100}=\frac{1}{400}.$$

Pelo TLC, temos que: $\displaystyle \bar{X}_{n}\sim N\left(\frac{1}{2},\frac{1}{400}\right)$
